    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="学生证号" align="center" key="idNumber" prop="idNumber" :show-overflow-tooltip="true" />
          ...
          <el-table-column label="学生认证" align="center" key="status" v-if="columns[5].visible">
